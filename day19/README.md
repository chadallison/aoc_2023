Advent of Code: 19 December 2023
================
...
parts = paste0("c(", gsub("[{}]", "", df[cumsum(df == "") == 1][-1]), ")")
...
sprintf("part 1 solution: %s", sum(sapply(parts, snd_workflow)))
```

    ## [1] "part 1 solution: 446935"
...
sprintf("part 2 solution: %.f", res)
```

    ## [1] "part 2 solution: 141882534122898"
