---
title: "Advent of Code: 23 December 2023"
...
```{r}
n = 141L
data23 = unlist(read.fwf("input.txt", widths = rep(1L, n), com = ""))
gr = unname(which(data23 != "#")) # graph
slp = c(">" = n, "<" = - n, "^" = -1L, "v" = 1L)

find_adj = function(k, part1 = T) {
...
# part 2
solve_day23(part1 = F) # takes < 2 minutes
```
